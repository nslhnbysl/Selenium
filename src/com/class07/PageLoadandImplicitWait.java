...
public static void main(String[] args) {
	...
	driver.manage().timeouts().pageLoadTimeout(30, TimeUnit.SECONDS); //only for page opening
	//tell webdriver to wait for the element before throwing NoSuchElementException
	//we need implicit wait
	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); //only for findElement/S
